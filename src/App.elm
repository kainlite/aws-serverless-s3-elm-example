        ...
        , div
            ...
            , div [ class "columns" ]
                [ div [ class "column auto" ]
                    [ Html.form [ class "form", method "post", action "https://p6c2wzb7s3.execute-api.us-east-1.amazonaws.com/dev/sendMail" ]
                        ...
                        , textarea [ class "textarea", placeholder "Let us know how we can help you..." ] []
                        , button [ class "button is-primary has-text-centered" ] [ text "Send" ]
                        ]
                    ]
                ]
            ]
